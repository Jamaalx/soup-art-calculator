        ...
        <div className="flex items-center justify-between">
          <div>
            <div className="flex items-center gap-3 mb-3">
              ...
              <span className="px-3 py-1 bg-white/20 rounded-full text-sm font-bold">RESTAURANT CALCULATOR</span>
            </div>
            <h1 className="text-4xl font-black mb-2">Restaurant Menu Pricing</h1>
            <p className="text-purple-100">
              Calculate prices for dine-in restaurant menu • {products.length} products available
            </p>
          </div>
        </div>
      </div>
